    ...
    <>
      <div className="terms_and_Contidition">
        ...
        <div className="terms_and_Contidition_2">
          <p>
            Home <span> &gt;&gt;Terms and Conditions</span>{" "}
          </p>
        </div>
      </div>
      ...
      <div className="terms_and_Contidition_3">
        <div className="terms_and_Contidition_top">
          ...
          <p>
            ...
            <span> Triangle Space Private Limited. </span>Throughout the site,
            the terms “we”, “us” and “our” refer to Triangle Space Private
            Limited. Triangle Space Private Limited offers this website,
        ...
        <div className="terms_and_Contidition_bottom">
          ...
          <div className="terms_and_Contidition_section">
            ...
            <p>
              In no case shall Triangle Space Private Limited, our directors,
          ...
          <div className="terms_and_Contidition_section">
            ...
            <p>
              ...
              <a href="mailto:info@trianglespace.in">
                <span> info@trianglespace.in.</span>
              </a>
            </p>
          </div>
        </div>
